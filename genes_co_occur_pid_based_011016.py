        ...
        if "Gene" in line and ("|a|" or "|t|") not in line :
            ...
            if len(line) > 4:
                ...
                if gene in pid_genes_dict:
                    pid_genes_dict[gene].append(p_id)
                else:
